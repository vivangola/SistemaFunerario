...
import CONTROLLER.RelMaterialController;
 ...
 */
public class RelMaterialView extends javax.swing.JFrame {

    /**
     * Creates new form PesquisarAcessoView
     */
    public RelMaterialView() {
        initComponents();
        MaterialDAO materialD = new MaterialDAO();
        MaterialModel materialM = new MaterialModel();
        RelMaterialController materialPC = new RelMaterialController(this, materialD, materialM, null, null, null);
        materialPC.iniciar();
    }
    ...
    private void initComponents() {
        ...
        lblNome1.setText("Materiais em Estoque");
        ...
        cmbOpcao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Todos", "Convalescença", "Decorações", "Religiosos", "Urnas" }));

        lblCPF10.setText("Categoria:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelMaterialView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelMaterialView().setVisible(true);
            }
        });
    }
