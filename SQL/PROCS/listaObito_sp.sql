...
IF aux = 0 THEN
	...
	IF campo = 1 THEN
		SELECT a.codigo, a.fk_cpf, DATE_FORMAT(a.dataEntero, '%d/%m/%Y') as dataEntero, a.horaEntero, a.localEntero 
...
ELSE
	...
	DATE_FORMAT(a.dataEntero, '%d/%m/%Y') as dataEntero,DATE_FORMAT(a.dataObito, '%d/%m/%Y') as dataObito,DATE_FORMAT(a.dataVelorio, '%d/%m/%Y') as dataVelorio
