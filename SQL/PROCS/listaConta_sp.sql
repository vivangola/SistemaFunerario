...
IF campo = 1 THEN
SELECT c.codigo, t.nome as funcionario, DATE_FORMAT(c.dataInclusao, '%d/%m/%Y') as dataInclusao, CASE c.situacao WHEN 0 THEN 'Ativo' ELSE 'Inativo' END AS situacao, c.vencimentoMensalidade, p.nome AS plano
